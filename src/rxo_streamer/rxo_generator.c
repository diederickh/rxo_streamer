...
static int fill(rxo_generator* gen, int x, int y, int w, int h, int r, int g, int b);
static int add_number_string(rxo_generator* gen, const char* str, int x, int y);
static int add_char(rxo_generator* gen, rxo_generator_char* kar, int x, int y);

int rxo_generator_init(rxo_generator* g, int w, int h, int fps) {

  int i = 0;
  int dx = 0;
  int max_els = RXS_MAX_CHARS * 8; /* members per char */
  rxo_generator_char* c = NULL;
...
static int add_number_string(rxo_generator* gen, const char* str, int x, int y) {
 ...
 rxo_generator_char* found_char = NULL;
 int len = strlen(str);
 int i = 0;
 int k = 0;
